...
本文说明计算机协会如何为活动申报第二课堂学分。“[第二课堂](/concepts/second-classroom)”是什么、为什么与毕业和评奖评优挂钩，见词条。

对于计算机协会而言，每次举办活动（如 [CA101](/concepts/ca101) 讲座、[维修日](/repair/repair-day)、网络安全讲座等）后，参与活动的同学均可申报相应的第二课堂学分。由负责人统一整理申报材料并提交审核。

## 院级与校级学分的区别

由于计算机协会是**院级社团**，申报流程会根据活动级别、对接不同的[部门](/concepts/second-classroom-departments)而有所不同：
...
活动结束后，由负责人根据活动情况填写《第二课堂学分申报表》（<a href="/templates/event/second-classroom-form.doc">存档副本</a>，只用来了解表格长什么样——〔当年以素拓部或社团部发布的版本为准〕）。申报表需要包含活动的基本信息，如活动名称、时间、地点、参与人数、活动内容概述等。
...
根据签到记录核实实际参与人员名单，并按照学校标准确定每位参与者可获得的学分数额。如今已基本不用纸质签到小票，参与人员通过**签到名单导入**确认。
