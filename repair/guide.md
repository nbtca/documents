...
本文是维修队的电脑维修操作指南，涵盖维修前的安全与沟通、软件与物理维护、系统重装，以及各厂商笔记本的 BIOS 与恢复入口。基本的电脑维修技能是每一位维修队成员都应掌握的——目标始终是更高效、更安全地为有故障的电脑排障。
...
对于顽固垃圾软件，可以使用 [Geek](/repair/tools) 等工具进行强制删除。对于像“360安全管家”等顽固软件，可以进入 [PE 系统](/concepts/winpe)直接删除文件，再进入本机操作系统使用 Geek 清理残留文件。
