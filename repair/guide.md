...
本文是维修队的电脑维修操作指南，涵盖维修前的安全与沟通、通用故障诊断、软件与物理维护、系统重装，以及各厂商笔记本的 BIOS 与恢复入口。这些是每个维修队成员都该会的基本功。

本文的祖本是 2023 年 3 月戴上博起草的一份 Word 手册，见[维修操作指南（2023 年 Word 版）](/archived/2023/repair-guide-handbook)。清灰、换硅脂、拆后盖这几节今天仍是它的延续；那份手册的 readme 当时就写着“有意见修正请在 github 中提交”。
...
<Figure src="./assets/repair-teardown.webp" alt="拆开后盖的笔记本平放在桌上，内存条、固态硬盘、电池与散热风扇一览无余，队员俯身用手处理内部部件，旁边摊着螺丝收纳盒" caption="后盖一开，内存、固态、电池和风扇都在这一面。拆下的螺丝分开放，别混。" source="协会照片档案" wide />
