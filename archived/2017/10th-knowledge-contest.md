---
summary: 2017 年第十届计算机知识竞赛的题库，覆盖进制转换、端口、网络配置、硬件与安全常识，答案直接标在题干括号里。
archive:
  date: "2017—2018 学年"
  source: "协会档案袋 · 计算机协会归档/2017-2018"
  note: "照录；题干括号内即答案"
...
网络工作于——用于将两个局域网连接在一起并按MAC地址转发帧。（C）
...
一个168引脚的SDRAM模块提供了一个——位宽的数据路径。（C）
...
在Excel工作表的单元格中计算一组数据后出现########，这是由于——所致。（A）
...
〔照片档案里存有这一届的颁奖照片，但画面中的投影幕上是一份含学号与个人成绩的排名表，故未在此处引用。〕

## 新闻稿

2017年12月6日在晚8:30，计算机协会第10届计算机知识竞赛在S501隆重举行。本次竞赛由计算机协会综合事务部主办，旨在让更多小白理解计算机知识，同时丰富自己的课余生活。计算机知识竞赛，不仅仅是对自身计算机知识的考察，更是一次计算机协会之家成员的饕餮盛宴。

此次竞赛共有80多人参加，经过一小时的激烈竞争，五位成员获得优胜奖，梁爽和杨丰源又有两人分别获得三等奖和二等奖，而那林珍杰更是夺取第一名，赫然春秋霸。

不仅仅是这些获奖的人，小白们的苦苦思索将会使他日后成为大神，成员们的建议那是协会未来发展的明灯，每一次键盘的敲打那是奏响成功的乐章，每一个人都在敲打着自己的传奇。

他们的参与为这寒冷的冬天增添了无穷的温暖。而这无疑是一次成功的活动。

〔原件正文中另有“激烈的比赛”一处小标题，以及“优胜奖获得者”“第二名与第三名”“第一名”三处图注，对应的照片未随文档保留，图注照录为小标题会造成误解，故此处略去，只保留正文。

主办部门写的是**综合事务部**——那是[这一学年新设的部门](/archived/2018/2017-2018-work-report)，职责里明写“直接负责历年计算机知识竞赛的开展”。〕

## 成绩

档案里另有一份成绩导出（CSV），逐行记着序号、学号、姓名与分数。按本站的[脱敏原则](/archived/index)，个人分数与学号不逐条收录，只给汇总；获奖名单当年本就是公开宣布的，照录。
...
获奖：第一名林珍杰（75），第二名杨丰源（72），第三名梁爽（70）。

〔人数对不上。新闻稿写“共有80多人参加”，成绩表只有 23 条记录，且序号在 3 到 25 之间——像是一张 25 人的表。可能的解释是成绩表只导出了其中一场／一批，或“80 多人”计的是报名与到场人数而非计入成绩的人数。两个数字都照录，不作裁定。

同一学年的[工作报告](/archived/2018/2017-2018-work-report)把这场竞赛记在 12 月 8 日，与新闻稿的 12 月 6 日又差两天。〕
