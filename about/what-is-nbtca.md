...
浙大宁波理工学院计算机协会（NBTCA）是一个诞生于 2001 年的计算机社区：在校园里，它是一个学生社团；在互联网上，它是一个开源社区——两面是同一群人。把大家聚在一起的是同一件事：**站在科技与人文的十字路口，用技术做对身边人真正有用的事**——比如把同学抱来的那台电脑修好。

<FactStrip :facts="[
  { label: '名字', value: '计算机协会，社区里习惯叫它 NBTCA' },
  { label: '出身', value: '2001 年建校时由初代社长叶敏辉创立' },
  { label: '依托', value: '线下挂靠学校的计算机学院' },
  { label: '在线', value: '代码与文档都公开在 GitHub' },
]" />
